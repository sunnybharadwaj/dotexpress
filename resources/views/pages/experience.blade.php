        ...
        <div class="section-intro">
            <div class="container">
                <div class="flex flex-wrap">
                    ...
                    <div id="experience-video-link" class="video w-full lg:w-5/12">
                    ...
                    <div id="experience-video-modal" class="video-modal hidden">

                        <div class="close-btn">
                            <img src="/static/icons/icon_close_white.svg" alt="Close Video">
                        </div>
                        <div class="video-container">
                            <iframe src="https://www.youtube.com/embed/nfQHF87vY0s" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="activity w-full md:w-1/2">
                        <div class="workshop">
                            <div class="image">
                                <div class="img-container">
                                    <img src="/static/experience/ikigai.jpg" alt="">
                                </div>
                                <div class="attribution small opacity-50 mt-2">Ismat Chughtai by Varunkika Saraf</div>
                            </div>
                            <div class="text">
                                <div class="mb-4">
                                <h5 class="p activity-title">Workshop</h5>
